...
class GCT(object):
    ...
    def get_gctx_cid_inds(self,src,match_list=None):
        ...
        if match_list == None:
            ...
            cid_idx = dict(list(zip(cid, list(range(len(cid))))))
    ...
    def get_gctx_rid_inds(self, src, match_list = None):
        ...
        if match_list == None:
            ...
            rid_idx = dict(list(zip(rid, list(range(len(rid))))))
    ...
    def read_gctx_matrix(self,src=None,cid=None,rid=None,col_inds=None,
        ...
        # then read in that orientation
            ...
            if row_optimized:
                ...
                # iteration
                col_ind_set = dict(list(zip(col_inds,col_inds)))
    ...
    def read(self,src=None,verbose=True,cid=None,rid=None,
        ...
        except GCTException as xxx_todo_changeme:
    ...
    def build(self, matrix, rid, cid,
        ...
        unicode2str = lambda x: str(x) if type(x) is str else x
